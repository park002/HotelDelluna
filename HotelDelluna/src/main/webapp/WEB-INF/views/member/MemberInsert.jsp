...
<body class="stretched">
        ...
        <header id="header" class="full-header">
            <div id="header-wrap">
                <div class="container clearfix">
                    ...
                    <div id="logo">
		<a href="<c:url value='/'/>" class="standard-logo" data-dark-logo= 
	...
	<a href="<c:url value='/'/>" class="retina-logo" data-dark-logo="<c:url value='/resources/images/logo/logo-dark-large.png' />">
			<img src="<c:url value='/resources/images/logo/footer-logo-large.png'/>" alt="Chocolat Logo"></a>
	</div>
                                    <!-- Primary Navigation
                    ============================================= -->
