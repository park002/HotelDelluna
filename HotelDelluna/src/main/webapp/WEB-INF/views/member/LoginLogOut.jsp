				...
				<div class="login100-form-title"
					...
					<span class="login100-form-title-1">Hotel Delluna</span>
						...
						<form class="login100-form validate-form">
							...
							<input class="input100" type="text" id="m_id" name="m_id" placeholder="Enter username">
								<span class="focus-input100"></span>
							</div>
							<div class="wrap-input100 validate-input m-b-18"
								data-validate="비밀번호를 입력해주세요">
								<span class="label-input100">비밀번호</span>
							 <input class="input100" type="password" id="m_password" name="m_password" placeholder="Enter password">
								<span class="focus-input100"></span>
							</div>
